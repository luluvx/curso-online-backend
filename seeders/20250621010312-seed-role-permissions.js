...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const permisosMap = Object.fromEntries(permisos[0].map(permiso => [permiso.codigo, permiso.id]));
    ...
    const permisosProfesor = [
      'CREATE_COURSE', 'VIEW_COURSES', 'VIEW_COURSE', 'UPDATE_COURSE', 'DELETE_COURSE',
      'ADD_VIDEO', 'VIEW_VIDEOS', 'VIEW_VIDEO', 'UPDATE_VIDEO', 'DELETE_VIDEO',
      'ASSIGN_GRADE', 'VIEW_GRADES', 'LIST_ENROLLMENTS'
    ];
    ...
    const permisosEstudiante = [
      'ENROLL_COURSE', 'VIEW_MY_COURSES',
      'VIEW_VIDEOS', 'VIEW_VIDEO',
      'VIEW_MY_GRADES',
